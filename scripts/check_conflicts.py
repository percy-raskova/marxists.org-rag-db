...
class BoundaryChecker:
            ...
            for line in content.split("\n"):
                ...
                if line.startswith("from ") or line.startswith("import "):
                    ...
                    if line.startswith("from "):
                        ...
                        if module == "src":
                            module_path = line.split(" ")[1].replace(".", "/") + "/"
    ...
    def check_all_boundaries(self) -> tuple[list[BoundaryViolation], bool]:
        ...
        if not self.current_instance:
            print("❌ Cannot detect current instance. Please set with --instance or create .instance file")
            return [], False
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Check for boundary violations between instances"
    )
    parser.add_argument(
        "--instance",
    ...
    parser.add_argument(
        "--list-boundaries",
        action="store_true",
        help="List all instance boundaries"
    )
